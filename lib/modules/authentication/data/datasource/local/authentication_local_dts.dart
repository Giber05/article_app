...
import 'package:article_app/infrastructure/local_storage/secure_storage/secure_storage.dart';
import 'package:article_app/modules/authentication/data/mapper/local/session_local_mapper.dart';
...
class AuthLocalDTSImpl implements AuthenticationLocalDTS {
  ...
  final _userSessionKey =
      "article.app.lib.modules.authentication.data.datasource.local.authentication_local_dts.dart";
